...
**Repo conventions:** direct-to-`main`, no feature branches; commits explain the *why*; no speculative abstractions; the 1376-test grok-free suite is the floor — every change keeps it green.
