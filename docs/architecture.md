...
| [src/feedback.ts](../src/feedback.ts) | Pure thumbs-feedback helpers (#114) — `turn_number` mapping, availability, snake_case params; see [research/turn-feedback.md](../research/turn-feedback.md) |
