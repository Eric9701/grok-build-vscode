(function (root) {
  ...
  const HOST_MESSAGE_TYPES = [
    ...
    "voiceError", "chips", "commandsUpdate", "mentionResults", "projectDirListing", "projectFileContent", "userMessage", "agentStart", "thoughtChunk",
  ...
  const WEBVIEW_MESSAGE_TYPES = [
    ...
    "recheckConnection", "listSessions", "listRepoSessions", "selectRepo", "toggleRepoPin", "setRepoArchived", "setRepoColor", "toggleSessionPin", "resumeSession", "renameSession", "deleteSession",
      "clearAllSessions", "pickFile", "mentionQuery", "addMentionFile", "listProjectDir", "readProjectFile", "pasteImage", "uploadFile", "voiceStart", "voiceStop",
